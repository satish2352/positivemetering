...
import im from "../../Assets/img/homeimg/Group 1000003866.png"
const MainBanner = () => {
    return (
            ...
            <Row>
                ...
                <Col lg={8}>
                    ...
                    <Row className='welcomesection2  '>
                        ...
                        <Col lg={10} md={12} className='welcomesectionleft shadow-lg' >
                            <Row>
                                <Col sm={6}>
                                    <h2>ABOUT US</h2>
                                ...
                                <Col sm={6} className=' d-flex align-items-center'><img src={im} className=' img-fluid' alt="" /></Col>
                            </Row>
                        </Col>
                    </Row>
                </Col>
